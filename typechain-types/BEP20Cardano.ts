...
export interface BEP20CardanoInterface extends Interface {
  getFunction(
    nameOrSignature:
      | "_decimals"
      | "_name"
...
export interface BEP20Cardano extends BaseContract {
  connect(runner?: ContractRunner | null): BEP20Cardano;
  waitForDeployment(): Promise<this>;

  interface: BEP20CardanoInterface;
